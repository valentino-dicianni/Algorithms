...
/**
 * function that tests the insertion_sort function on a NULL array
 */
...
/**
 * function that tests the insertion_sort function on an empty array
 */
...
/**
 * function that tests the insertion_sort function on an all equal element array
 */
void test_insertion_sort_on_all_equal_element_array() {
    ...
    start_time = clock();
    insertion_sort((void**) array, SIZE, compare_int_ptr);
    double elapsed_time = (clock() - start_time)/(double)CLOCKS_PER_SEC;
 ...
 * array to order.
 * The insertion_sort() function orders the array, the assert() tests if the array was ordred correctly;
 * and finally the free() frees spaces in memory.
 */
 
void test_insertion_sort_on_full_ptr_array_string() {
    char* id,
    * field1,
    * field2,
    * field3;
    ...
    start_time = clock();
    insertion_sort((void**) array, SIZE, compare_string_ptr);
    double elapsed_time = (clock() - start_time)/(double)CLOCKS_PER_SEC;
...
void test_insertion_sort_on_full_ptr_array_int() {
    char* id,
    * field1,
    * field2,
    * field3;
...
void test_insertion_sort_on_full_ptr_array_float() {
    char* id,
    * field1,
    * field2,
    * field3;
    ...
    start_time = clock();
    insertion_sort((void**) array, SIZE, compare_float_ptr);
    double elapsed_time = (clock() - start_time)/(double)CLOCKS_PER_SEC;
...
int main(int argc, char const *argv[]) {
  ...
  test(test_insertion_sort_on_all_equal_element_array);
  test(test_insertion_sort_on_full_ptr_array_int);
  test(test_insertion_sort_on_full_ptr_array_string);
  test(test_insertion_sort_on_full_ptr_array_float);
