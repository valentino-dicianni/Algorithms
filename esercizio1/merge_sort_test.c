...
/*
 * function that tests the merge_sort function on a NULL array
 */
...
/*
 * function that tests the merge_sort function on an empty array
 */
...
/*
 * function that tests the merge_sort function on an all equal element array
 */

void test_merge_sort_on_all_equal_element_array() {
  int** array;
  ...
  start_time = clock();
  merge_sort((void**) array, SIZE, compare_int_ptr);
  double elapsed_time = (clock() - start_time)/(double)CLOCKS_PER_SEC;
 ...
 * array to order.
 * The merge_sort() function orders the array, the assert() tests if the array was ordred correctly;
 * and finally the free() frees spaces in memory.
 */

void test_merge_sort_on_full_ptr_array_string() {
  char* id,
  * field1,
  * field2,
  * field3;
  ...
  start_time = clock();
  merge_sort((void**) array, SIZE, compare_string_ptr);
  double elapsed_time = (clock() - start_time)/(double)CLOCKS_PER_SEC;
...
void test_merge_sort_on_full_ptr_array_int() {
  char* id,
  * field1,
  * field2,
  * field3;
...
void test_merge_sort_on_full_ptr_array_float() {
  char* id,
  * field1,
  * field2,
  * field3;
  ...
  fclose(fp);
  start_time = clock();
  merge_sort((void**) array, SIZE, compare_float_ptr);
  double elapsed_time = (clock() - start_time)/(double)CLOCKS_PER_SEC;
...
int main(int argc, char const *argv[]) {
  ...
  test(test_merge_sort_on_full_ptr_array_int);
  test(test_merge_sort_on_full_ptr_array_string);
  test(test_merge_sort_on_full_ptr_array_float);
  test(test_merge_sort_on_all_equal_element_array);
  end_tests();
  return 0;
}